...
See LuaPower website/repo for legacy Glue library!
...
Returns a deep copy of a given table, it can be used to remove value references.
...
Returns an array of chunks made of `n` elements from a given list.

__NOTE:__ If there are not enough `n` elements in the list the chunk will be "truncated".
